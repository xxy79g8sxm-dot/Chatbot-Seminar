...
<div class="chat-container">
  <div class="chat-header" id="bot-header-name">💬 Chatbot Demo</div>
...
let keywords = JSON.parse(localStorage.getItem("chatKeywords")) || [
  ...
  {word: "hilfe", response: "Natürlich, wobei brauchst du Hilfe?"},
  {word: "wetter", response: "Ich bin kein Wetterdienst, aber es sieht immer sonnig aus im Chat! ☀️"},
  {word: "tschüss", response: "Auf Wiedersehen! Bis bald!"}
];
// Botname persistent speichern (auch nach Neuladen!)
let botName = localStorage.getItem("botName") || "💬 Chatbot Demo";
...
function updateKeywordList() {
  ...
  keywords.forEach((item, index) => {
    ...
    div.innerHTML = `<span><strong>${item.word}</strong>: ${item.response}</span>
                     <button class="delete-btn" onclick="deleteKeyword(${index})">❌</button>`;
